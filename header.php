<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      ...
      <li class="nav-item">
        <a class="nav-link" href="events.php">Things to do</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="restaurants.php">Restaurants</a>
      </li>
    </ul>
    <label class='pr-2 pt-2 text-light' for='logout'><?php
    ...
    <a href="actions/a_logout.php?logout"><button type='button' class='btn btn-light' id='logout'>Sign Out</button></a>
  </div>
</nav>
