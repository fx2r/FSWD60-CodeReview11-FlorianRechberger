...
<html>
	...
	<body>
		<!----------update action----------->
		<?php require_once 'actions/a_update_things_to_do.php';?>
		<!----------action message----------->
		...
		<main class="container pt-4">
			<div class="row justify-content-center">
				<div class="col-sm-10 col-md-7 col-lg-5 col-xl-4 mb-4">
					<form action="actions/a_update_things_to_do.php" method="POST" >
			     		<div class="card">
							...
							<!-- <label for="type">Type</label> -->
				                <input type="text" class="form-control" name="type" id="type" placeholder="Type" maxlength="40" value="<?php if (isset($_SESSION['type'])) {echo $_SESSION['type']; unset($_SESSION['type']);}else{echo $type;}?>" />
				                <span class="text-danger">
				            ...
				            <!-- <label for="city">City</label> -->
								...
								<br>
								<div class="mt-2">
								<input type="hidden" name="to_do_id" value="<?php echo $to_do_id?>">
